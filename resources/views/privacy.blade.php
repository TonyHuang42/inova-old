...
@section('title', 'Privacy Policy - INOVA')
        ...
        <div class="row">
            <div class="col-12 col-lg-10 col-xl-8 mx-auto">
                ...
                <div class="section">
                    ...
                    <p>This information is collected through cookies and similar technologies. For more details, see our <a href="/privacy-policy#cookie">Cookies and Tracking Technologies</a> below.</p>
                    <h3>Information You Provide</h3>
                    <p>If you contact us via a contact form or email, we may collect:</p>
                    <ul>
                        <li>Your name.</li>
                ...
                <div class="section">
                    ...
                    <ul>
                        ...
                        <li>To analyze how users interact with the Website and improve its content and functionality.</li>
                ...
                <div class="section">
                    ...
                    <ul>
                        ...
                        <li>If required by <strong>law</strong> or to protect our rights, property, or safety, or the rights, property, or safety of others.</li>
                        <li>In the event of a <strong>business transfer</strong> (e.g., if we merge with or are acquired by another entity).</li>
                    </ul>
                </div>
                ...
                <div class="section" id="cookie">
                    ...
                    <p>Cookies are small text files stored on your device when you visit a website. They help us improve your experience by remembering your preferences and analyzing how you use the Website.</p>
                    ...
                    <p>You can manage or disable cookies through your browser settings. However, disabling cookies may affect your ability to use certain features of the Website.</p>
                </div>
