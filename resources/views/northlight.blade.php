            ...
            <div class="col-lg-9 mx-auto">
                ...
                <div class="row bottom-padding-sm gx-md-5">
                    ...
                    <div class="col-md-6 d-flex align-items-center order-1 order-md-2">
                        <div class="highlight-features-img-wrap rounded-img">
                            <img src="{{ asset('img/phone/Inova_spec_parts_battery.png') }}" alt="battery" class="img-fluid" style="max-height: 300px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="row bottom-padding gx-md-5">
                    ...
                    <div class="col-md-6 d-flex align-items-center order-1 order-md-2">
                        <div class="highlight-features-img-wrap rounded-img">
                            <img src="{{ asset('img/phone/Inova_spec_parts_microSD.png') }}" alt="microSD" class="img-fluid" style="max-height: 300px;">
                        </div>
                    </div>
                </div>
            </div>
